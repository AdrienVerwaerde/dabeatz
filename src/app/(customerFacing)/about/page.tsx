...
export default function About() {
    return (
        <div className="flex flex-col justify-center items-center container text-center font-mono">
            ...
            <a href="https://adrienverwaerde.github.io/Portfolio/" target="_blank"><Button className="font-sans text-2xl bg-pink-800 hover:bg-black p-6 mt-4">Portfolio</Button></a>
        </div>
    )
}