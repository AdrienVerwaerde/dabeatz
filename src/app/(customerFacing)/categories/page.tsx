...
export default function CategoriesPage() {
    return (
        ...
        <h1 className="uppercase text-pink-800 font-bold text-lg mt-4 mb-0 lg:mt-0 lg:mb-4 w-fit text-center p-2 rounded-md border-solid border-pink-800 border-2">Categories</h1>
